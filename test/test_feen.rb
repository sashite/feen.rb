...
begin
  ...
  raise "Test 4 failed: white king not correctly parsed" unless white_king == "K>"
  raise "Test 4 failed: black king not correctly parsed" unless black_king == "k<"
...
begin
  original = "rnbqk=bnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQK=BNR - CHESS/chess"
...
begin
  canonical_feen = "rnbqk=bnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQK=BNR - CHESS/chess"
